...
public class GetTeamRouter {
    ...
    @Bean
    @RouterOperation(operation = @Operation(operationId = "get", summary = "- Get Team by Id", tags = {"Team"},
            parameters = {@Parameter(in = ParameterIn.PATH, name = "id", description = "Get Team by Id")},
            responses = {
